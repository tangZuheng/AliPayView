...
class FiveStarCellCell: UITableViewCell {
    ...
    func initfaceView() {
        ...
        nameLabel.textColor = UIColor.init(rgb: 0x282828)
        ...
        starView.starNumber = 5
        
        remainingTimeLabel.text = "累计:1天"
